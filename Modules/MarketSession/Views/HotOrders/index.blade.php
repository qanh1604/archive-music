...
<!--                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#exampleModal">
    ...
    <!--                    <td>
                        ...
                        <td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('hot-order.edit', encrypt($order->id))}}" title="{{ translate('Edit') }}">
                            ...
                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('hot-order.destroy', $order->id)}}" title="{{ translate('Delete') }}">
...
//        }
        ...
        function bulk_delete() {
            ...
            $.ajax({
                ...
                url: "{{route('hot-order.bulk-order-delete')}}",
                type: 'POST',
                data: data,
                cache: false,
                contentType: false,
