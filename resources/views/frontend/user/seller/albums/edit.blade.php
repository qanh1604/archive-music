...
<div class="">
    <form class="form form-horizontal mar-top" action="{{route('selleralbum.updateAlbum', $album->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="aiz-text-editor" name="lyric">{{ $album->description }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
